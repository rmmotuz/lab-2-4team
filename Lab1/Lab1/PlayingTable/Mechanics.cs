        ...
        while (start)
        {
            ...
            switch (keyInfo.Key)
            {
                case ConsoleKey.UpArrow:
                    if (SelectionIndex - 3 < 0) { continue; }
                    Console.Clear();
                    SelectionIndex -= 3;
                    obj.DrawBoard(board, SelectionIndex, PlayerTurn);
                    playerHelper.PlayerTurn(players, PlayerTurn);
                ...
                case ConsoleKey.DownArrow:
                    if (SelectionIndex + 3 > 8) continue;
                    Console.Clear();
                    SelectionIndex += 3;
                    obj.DrawBoard(board, SelectionIndex, PlayerTurn);
                    playerHelper.PlayerTurn(players, PlayerTurn);
                ...
                case ConsoleKey.RightArrow:
                    if (SelectionIndex + 1 > 8) continue;
                    Console.Clear();
                    SelectionIndex++;
                    obj.DrawBoard(board, SelectionIndex, PlayerTurn);
                    playerHelper.PlayerTurn(players, PlayerTurn);
                ...
                case ConsoleKey.LeftArrow:
                    if (SelectionIndex - 1 < 0) continue;
                    Console.Clear();
                    SelectionIndex--;
                    obj.DrawBoard(board, SelectionIndex, PlayerTurn);
                    playerHelper.PlayerTurn(players, PlayerTurn);
                ...
                case ConsoleKey.Enter:
                    ...
                    {
                        Console.Clear();
                        board[SelectionIndex] = players[0].Symbol;
                        obj.DrawBoard(board, SelectionIndex, PlayerTurn);
                        playerHelper.PlayerTurn(players, PlayerTurn);
                        PlayerTurn = 1;
                        start = false;
                    ...
                    {
                        Console.Clear();
                        board[SelectionIndex] = players[1].Symbol;
                        obj.DrawBoard(board, SelectionIndex, PlayerTurn);
                        playerHelper.PlayerTurn(players, PlayerTurn);
                        PlayerTurn = 0;
                        start = false;
